  ...
  e2e: {
    ...
    setupNodeEvents(on) {
      on('task', {
        ...
        stubStartIncentivesMigration: nomisMigrationApi.stubStartIncentivesMigration,
        ...
        stubDeleteIncentivesFailures: nomisMigrationApi.stubDeleteIncentivesFailures,
        ...
        stubGetIncentiveMigrationEstimatedCount: nomisPrisonerApi.stubGetIncentiveMigrationEstimatedCount,
        stubGetVisitsMigrationDetailsStarted: nomisMigrationApi.stubGetVisitsMigrationDetailsStarted,
        stubGetIncentivesMigrationDetailsStarted: nomisMigrationApi.stubGetIncentivesMigrationDetailsStarted,
        stubGetVisitsMigrationDetailsCompleted: nomisMigrationApi.stubGetVisitsMigrationDetailsCompleted,
        stubGetIncentivesMigrationDetailsCompleted: nomisMigrationApi.stubGetIncentivesMigrationDetailsCompleted,
