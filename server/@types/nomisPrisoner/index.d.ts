...
export type PageCSIPIdResponse = components['schemas']['PageCSIPIdResponse']
...
export type GetCSIPIdsByFilter = Omit<operations['getCSIPIdsByFilter']['parameters']['query'], 'pageRequest'>
