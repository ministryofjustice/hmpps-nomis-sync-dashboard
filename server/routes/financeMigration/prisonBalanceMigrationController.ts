...
export default class PrisonBalanceMigrationController {
  constructor(
    private readonly prisonBalanceMigrationService: PrisonBalanceNomisMigrationService,
    private readonly nomisPrisonerService: PrisonBalanceNomisPrisonerService,
  ...
  async getMigrations(_: Request, res: Response): Promise<void> {
    ...
    res.render('pages/finance/prisonBalanceMigration', {
  ...
  async viewFailures(_: Request, res: Response): Promise<void> {
    ...
    res.render('pages/finance/prisonBalanceMigrationFailures', { failures: failuresDecorated })
  }
  ...
  async startMigration(req: Request, res: Response): Promise<void> {
    res.render('pages/finance/startPrisonBalanceMigration', {
  ...
  async startMigrationPreview(req: Request, res: Response): Promise<void> {
    res.render('pages/finance/startPrisonBalanceMigrationPreview', {
      form: req.session.prisonFilteredMigrationForm,
    })
  }
  ...
  async startMigrationConfirmation(req: Request, res: Response): Promise<void> {
    res.render('pages/finance/startPrisonBalanceMigrationConfirmation', {
      form: req.session.prisonFilteredMigrationForm,
    })
  }
  ...
  async migrationDetails(req: Request, res: Response): Promise<void> {
    ...
    res.render('pages/finance/prisonBalanceMigrationDetails', {
      migration: { ...migration, history: PrisonBalanceMigrationController.withFilter(migration.history) },
    })
  }
